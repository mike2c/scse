						...
						<div class="active tab-pane" id="miperfil">
							<form class="form-horizontal" id='form_actualizar_perfil' action="<?=base_url('egresado/actualizar_perfil')?>" method='post'>
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input value=<?=$perfil->ruc?> name="cedula" type="text" class="form-control input-sm cedula">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2">Nombre</label>
									<div class="col-sm-6">
										<input value=<?=$perfil->nombre_empresa?> placeholder="nombre" name="nombre" type="text" class="form-control input-sm">
									</div>
								</div>
								<div class="form-group">
