	...
	<div class="row">
			...
			<div class="box box-solid">
				...
				<div class="box-body no-padding" style="display:block;">
					<ul class="nav nav-pills nav-stacked">
						<li class="active"><a href="<?=base_url('correo/inbox')?>">Bandeja de entrada <span class="label label-primary pull-right"><?=$cantidad_inbox?></span></a></li>
						<li><a href="<?=base_url('correo/sent')?>">Bandeja de salida <span class="label label-primary pull-right"><?=$cantidad_sent?></span></a></li>
						<li><a href="<?=base_url('correo/drafts')?>">Borradores <span class="label label-primary pull-right"><?=$cantidad_drafts?></span></a></li>
		...
		<div class="col-md-9 col-lg-9" id="contenido">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Mensajes de entrada</h3>
					<div class="box-tools pull-right">
						<form action="<?=base_url('correo/inbox')?>" method="post" id="form_buscar_correo">
				...
				<div class="box-body no-padding">
					<div class="mailbox-controls">
						...
						<a href="<?=base_url('correo/inbox')?>" class="btn btn-default btn-sm"><i class="fa fa-refresh"></i></a>
					</div>
									...
									<table class="table table-hover table-striped">
										<?
											foreach ($mensajes->result() as $row) {
												...
												<td>De: $row->remitente</td>
												<td><a href='javascript:leer_mensaje_entrada($row->mensaje_id)'>$row->asunto</a></td>
												<td>Enviado el $row->fecha_envio</td>";
												if($row->visto == true){
													echo "<td class='text-primary'>visto</td>";
												}else{
													echo "<td class='text-danger'>sin leer</td>";
												}
												echo "</tr>";
											}
										?>
