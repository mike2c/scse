			...
			<div class="box box-solid">
				...
				<div class="box-body no-padding" style="display:block;">
					<ul class="nav nav-pills nav-stacked">
						<li class="active"><a href="<?=base_url('correo/inbox')?>">Bandeja de entrada <span class="label label-primary pull-right">12</span></a></li>
						<li><a href="<?=base_url('correo/sent')?>">Bandeja de salida <span class="label label-primary pull-right">12</span></a></li>
